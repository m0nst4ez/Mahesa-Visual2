...
if (Edtnamapoin.Text='') or (Edtbobot.Text='') then
  ...
  begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('insert into poin values (null,"'+Edtnamapoin.Text+'","'+Edtbobot.Text+'","'+cbbjenis.Text+'")');
  ZQuery1.ExecSQL;
...
begin
  ...
  if (Edtnamapoin.Text = ZQuery1.FieldList[1].AsString) and (Edtbobot.Text = ZQuery1.FieldList[2].AsString) and (cbbjenis.Text = ZQuery1.FieldList[3].AsString) then
  begin
  ...
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('Update poin set nama_poin="'+Edtnamapoin.Text+'", bobot="'+Edtbobot.Text+'", tipe_poin="'+cbbjenis.Text+'" where id="'+id+'"');
  ZQuery1.ExecSQL;
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('select*from poin');
  ZQuery1.Open;
